...
SecurityComponent.ɵcmp = /*@__PURE__*/ _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵdefineComponent"]({ type: SecurityComponent, selectors: [["app-security"]], viewQuery: function SecurityComponent_Query(rf, ctx) { if (rf & 1) {
    ...
    } }, decls: 11, vars: 2, consts: [[1, "container-fluid"], [1, "row"], [1, "col-sm-12"], [1, "card"], [1, "card-header"], [1, "card-body", "custom-datatable"], ["type", "text", "placeholder", "Type to filter the name column...", 1, "filter-ngx", "form-control", 3, "keyup"], [3, "user_data", "columns", "checkout", "checkin", "view"]], template: function SecurityComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵlistener"]("checkout", function SecurityComponent_Template_app_table_checkout_10_listener($event) { return ctx.onCheckOut($event); })("checkin", function SecurityComponent_Template_app_table_checkin_10_listener($event) { return ctx.onCheckIn($event); })("view", function SecurityComponent_Template_app_table_view_10_listener($event) { return ctx.onView($event); });
        _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵelementEnd"]();
...
class VisitiorProfileComponent {
    ...
    saveImage(image) {
        // console.log(image);
        this.service
            .addPhoto({ img_url: image, id: this.selectedID })
            .subscribe((res) => {
...
VisitiorProfileComponent.ɵcmp = /*@__PURE__*/ _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵdefineComponent"]({ type: VisitiorProfileComponent, selectors: [["app-visitor-profile"]], decls: 1, vars: 2, consts: [[3, "user_data", "status", "saveimage"]], template: function VisitiorProfileComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵproperty"]("user_data", ctx.row)("status", ctx.status);
